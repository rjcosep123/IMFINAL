                ...
                <table class="min-w-full bg-white rounded-lg shadow overflow-hidden">
                    <thead class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        <tr>
                            ...
                            <th class="py-3 px-6 text-left">Allocation</th>
                    ...
                    <tbody class="text-gray-700 text-sm">
                                ...
                                <td class="py-3 px-6">
                                    <span class="inline-block px-2 py-1 text-xs font-medium rounded
                                        @switch($member->status)
                                            ...
                                            @case('Inactive') bg-gray-200 text-gray-800 @break
                                            @case('On Leave') bg-yellow-200 text-yellow-800 @break
                                            @case('Suspended') bg-red-200 text-red-800 @break
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="py-4 px-6 text-center text-gray-500">No staff found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
